import BlynkLib, requests, datetime
...
# declaring variables for the pixel array
...
# The register handler for the Blynk app Alarm state
@blynk.on("V0")
...
# The register handler for the Blynk app Armed state
@blynk.on("V2")
...
# Checks light levels. If above 5, sets the alarm state
def light_check():
    global breakout
    global alarm
    global light
